const members = {
    ...
    "01814843266":{
        ...
        pre_previous_payable:2821,
        previous_paid       :5000,
        previous_dining_cost:1568,
        payment             :{"27-11-23-Cash":4000},
        // running month
        stay_cost       :2200,
        garage_cost     :0,
        running_payable :2284,
        running_paid    :4000,
        running_meal    :2,
        // method calling
        previousAddedDining,
    ...
    "01738393696":{
        name:"Amrul Qais",
        pre_previous_payable:3392,
        previous_paid       :5000,
        previous_dining_cost:2352,
        payment             :{"02/12/23-Cash":6000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
...
function opener(){
    ...
    if(user_number.length === 11){
        ...
        || user_number === "01834648400"){
            ...
            const piyas              = members["01834648400"].name;
            const piyasMealCost      = members["01834648400"].runningDiningCost();
            const piyasMealPaid      = members["01834648400"].runningAddedDining();
            const piyasMealRemaining = members["01834648400"].runningRemainingDiningCost();
            const piyasMealDue       = members["01834648400"].runningDueDiningCost();
            ...
            if(user_number!=="01532023080"){
                document.getElementById("garageOrextra").innerText ="Extra cost";
            }
         }else{
            console.log("Hi!")
        }
